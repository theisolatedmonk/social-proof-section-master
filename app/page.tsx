    ...
    <div className="text-xl font-League_Spartan flex flex-col sm:justify-center items-center p-5 py-20  gap-8 sm:p-20 relative">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between gap-8 w-full sm:items-center " >
        <div className="flex flex-col gap-8">
          ...
          <p className="text-center text-DarkGrayishMagenta sm:text-start sm:pr-10 sm:px-0">We only provide great products combined with excellent customer service. See what our satisfied customers are saying about our services.</p>
